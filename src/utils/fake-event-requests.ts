...
export function requestEventsInRange(startStr: string, endStr: string) {
...
export function requestEventCreate(plainEventObject: any) {
...
export function requestEventUpdate(plainEventObject: any) {
...
export function requestEventDelete(eventId: string) {
